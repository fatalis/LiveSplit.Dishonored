...
namespace LiveSplit.Dishonored
{
    public partial class DishonoredSettings : UserControl
    {
        ...
        public DishonoredSettings()
        {
            ...
            this.SpeedupFloodedCell = 1500;
            this.SpeedupKingsparrow = 4500;
            this.SpeedupLighthouse = 1200;
        ...
        public void SetSettings(XmlNode settings)
        {
            ...
            this.SpeedupFloodedCell = ParseInt(settings, "SpeedupFloodedCell", 1500);
            this.SpeedupKingsparrow = ParseInt(settings, "SpeedupKingsparrow", 4500);
            this.SpeedupLighthouse = ParseInt(settings, "SpeedupLighthouse", 1200);
            ...
            this.DelayLighthouse = ParseInt(settings, "DelayLighthouse", 1500);
        }
